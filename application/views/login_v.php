...
<div class="row" style="margin-top: 20px;  text-align:center;">
	...
	<div class="text-center" style="margin-top: 20px;  text-align:center;">
		<img class="img-responsive" src="<?php echo base_url('assets/img/pos_logo_1.png')?>">
	</div>
	...
	<div class="form-group">
		<img src="<?php echo base_url('assets/img/users/no_image.png');?>" id="user_avatar" alt="user_avatar" class="img-circle" style="display: none;">
	</div>
